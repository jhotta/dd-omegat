--- title: Datadog-Microsoft Azure SQL Database Integration integration_title: Microsoft Azure SQL Database kind: integration doclevel: basic git_integration_title: azure_sql_database
newhlevel: true
---
