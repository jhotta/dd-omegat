--- title: Datadog Process Monitoring kind: guide listorder: 16
...
- `dd-agent``dd-process-agent` must be running when  is started for a host’s process information to appear in the “Live Processes” table.
